class AddConfirmableToDevise < ActiveRecord::Migration
  ...
  def up
    ...
    # spree_users as confirmed, do the following
    Spree::User.update_all(:confirmed_at => Time.now)
    # All existing user accounts should be able to log in after this.
  end

  def down
    remove_columns :spree_users, :confirmation_token, :confirmed_at, :confirmation_sent_at
    # remove_columns :spree_users, :unconfirmed_email # Only if using reconfirmable
  end
end