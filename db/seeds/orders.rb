...
orders[0].line_items.create!(
  :variant => Spree::Product.find_by_name!("All about nothing. How to get the most by investing at least").master,
  :quantity => 1,
  :price => 15.99)

orders[1].line_items.create!(
  :variant => Spree::Product.find_by_name!("Military methods in business. Tactics").master,
  :quantity => 1,
  :price => 22.99)
...
puts 'SAMPLE DATA -> Orders created'